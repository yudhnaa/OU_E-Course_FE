...
import { Container, Card, ProgressBar, Form, Button, Modal, Alert, Spinner, Row, Col, Badge } from 'react-bootstrap';
...
const ExerciseAttempt = () => {
    ...
    useEffect(() => {
        const fetchQuizData = async () => {
            try {
                ...
                // Fetch questions
                const questionsRes = await authApis().get(endpoints['exerciseQuestions'](courseId, exerciseId));
    ...
    const calculateScore = () => {
        ...
        questions.forEach(question => {
            ...
            if (selectedAnswerId) {
                const selectedAnswer = question.multipleChoiceAnswerSet.find(a => a.id === selectedAnswerId);
